...
#         Label                              Module ID                Icon                         Category      Advanced?                      Keywords for filter
    ...
    [_("Regional Settings"),                "region",             "cs-region",                     "prefs",      False,          _("region, layout, keyboard, language")],
    ...
    [_("Power Management"),                 "power",              "cs-power",                   "hardware",      False,          _("power, suspend, hibernate, laptop, desktop")],
...
#         Label                          Executable                          Icon                Category        Advanced?               Keywords for filter
    ...
    [_("Languages"),                     "gnome-language-selector",      "cs-language",        "prefs",          False,          _("language, install, foreign")],
